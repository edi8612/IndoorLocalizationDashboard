    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "AA:BB:CC:DD:EE:01", "Alice's iphone", 0f, 0f, 1 },
                    { 2, "AA:BF:CC:DD:EC:02", "Bob's iphone", 0f, 0f, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "wayne@university.edu", "hashedPassword123", "Professor", "wayne" },
                    { 2, "alice@university.edu", "hashedPassword1234", "Student", "alice" },
                    { 3, "bob@university.edu", "hashedPassword12345", "Student", "bob" }
                });

            migrationBuilder.InsertData(
                table: "Professors",
                columns: new[] { "Id", "Name", "UserId" },
                values: new object[] { 1, "Dr. Wayne", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 1, 1, "Alice Johnson", 2 },
                    { 2, false, 2, 2, "Bob Smith", 3 }
                });
